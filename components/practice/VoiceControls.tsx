...
export default function VoiceControls({
  ...
  return (
    <div className="sticky bottom-0 bg-white/95 backdrop-blur-sm border-t border-gray-200 px-6 py-4 shadow-[0_-2px_10px_rgba(0,0,0,0.04)]">
      <div className="max-w-3xl mx-auto flex items-center justify-between">
        ...
        <button
          ...
          className={`w-16 h-16 rounded-full flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all disabled:opacity-40 disabled:hover:scale-100 ${
            isMicMuted
              ? "bg-red-100 text-red-600 hover:bg-red-200 ring-4 ring-red-200"
              : "bg-green-100 text-green-600 hover:bg-green-200 ring-4 ring-green-200"
          }`}
        >
          {isMicMuted ? (
