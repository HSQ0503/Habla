    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="bg-white rounded-2xl border border-gray-200 p-8 max-w-md text-center shadow-lg">
          <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-indigo-50 ring-8 ring-indigo-50/50 flex items-center justify-center">
          ...
          <button
            onClick={requestMic}
            className="w-full px-4 py-2.5 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 shadow-sm hover:shadow transition-all mb-3"
          >
            Allow Microphone
          </button>
          <button
